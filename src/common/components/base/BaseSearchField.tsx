import { styled, TextField, TextFieldProps, InputAdornment, useTheme } from "@mui/material";
...
const StyledSearchField = styled(TextField, { shouldForwardProp: (prop) => prop !== "expanded" })<StyledProps>(({ theme, expanded }) => {
