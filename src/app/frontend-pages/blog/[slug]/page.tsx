...
export default async function Post({ params }: any) {
  const posts = getAllPosts(["title", "date", "excerpt", "coverImage", "slug"]);
  const post = getPostBySlug(params.slug, ["title", "author", "authorImage", "content", "coverImage", "date", "views", "comments", "category"]);
          ...
          <BlankCard>
            <>
              ...
              <CardContent>
                ...
                <Box my={3}>
                  <Typography gutterBottom variant="h1" fontWeight={600} color="inherit" sx={{ textDecoration: "none" }}>
                    {post?.title}
                  </Typography>
                </Box>
